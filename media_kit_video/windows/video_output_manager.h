...
class VideoOutputManager {
 public:
  ...
  // This forces |VideoOutput| to resize the internal D3D texture.
 ...
 private:
  ...
  // All the operations involving D3D11 or libmpv must be performed on the
  // same single thread to prevent race conditions around shared render state.
  ...
  //
  // All of the following tasks involve D3D11 or libmpv rendering state.
  // Following operations are performed through the |ThreadPool|:
  //
  // * Rendering of video frame after being notified by
